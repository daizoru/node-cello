...
(function() {
  ...
  CParser = function(func, options) {
    var ast, debug, evaluate, functionCall, functionDef, headers, ignore, include, includes, indent, indentationStr, mainCall, node, nodeToString, output, parseStatement, scope, scopes, _i, _len, _ref, _ref1, _ref2, _ref3;
    if (options == null) {
      options = {};
    }
    ...
    output = (parseStatement = function(nodes, ind) {
      var args, assigned, body, cond, n, res, statement, statements, value, _i, _j, _k, _len, _len1, _len2, _ref4, _ref5, _ref6;
      res = "";
      n = "" + nodes;
