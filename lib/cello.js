...
(function() {
  ...
  CParser = function(func, options) {
    var arr, ast, debug, ev, evaluate, headers, i, ig, ignore, include, includes, indent, indentationStr, node, output, parse, pretty, scope, scopes, _i, _j, _len, _len1, _ref, _ref1;
    if (options == null) {
      options = {};
    }
    ...
    if (options.evaluate != null) {
      ...
      console.log(inspect(ev, false, 20, true));
    ...
    output = (parse = function(nodes, ind) {
      var TMP, arg, args, buff, callee, code, cut, elements, fakeAST, first, n, name, nbArgs, p, param1, params, replaceOperators, result, statements, str, type, _j, _k, _len1, _len2, _ref2;
      if (!isArray(nodes)) {
        return "";
      }
      type = nodes[0];
      ...
      gcc.on('exit', function(code, signal) {
        ...
        return prog.on('exit', function(code, signal) {
          if (code !== 0) {
            ...
            return fs.unlink(binFile, function() {
