...
(function() {
  ...
  CParser = function(func, options) {
    ...
    output = (parse = function(nodes, ind) {
      var body, buff, callee, code, cond, cut, elements, first, n, name, p, param1, params, statement, statements, str, type, _i, _j, _k, _len, _len1, _len2, _ref2, _ref3;
      if (!isArray(nodes)) {
        return "";
      }
      type = nodes[0];
      ...
      switch (type) {
        ...
        case 'return':
          debug("RETURN");
          if (first[0] === 'call' && (_ref3 = first[1][1], __indexOf.call(TYPES, _ref3) >= 0)) {
            return parse(first);
          } else {
