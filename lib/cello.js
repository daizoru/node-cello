...
(function() {
  ...
  TYPES = ['int', 'uint', 'float', 'ufloat', 'long', 'ulong', 'double', '_const', 'char', 'uchar', 'float16', 'float32', 'int16', 'int32', '__kernel', 'void', 'Void', 'VOID', 'bool', 'boolean', 'integer', 'const'];
  ...
  CParser = function(func, options) {
    var ast, debug, evaluate, headers, ignore, include, includes, indent, indentationStr, node, output, parse, pretty, scope, scopes, _i, _len, _ref, _ref1, _ref2, _ref3;
    if (options == null) {
      options = {};
    }
    ...
    evaluate = evaluate[1][0][1][0][1][3][0][1][1];
    evaluate = (function() {
      var _i, _len, _results;
      _results = [];
      for (_i = 0, _len = evaluate.length; _i < _len; _i++) {
        node = evaluate[_i];
    ...
    output = (parse = function(nodes, ind) {
      var body, buff, callee, code, cond, cut, elements, first, n, name, p, param1, params, statement, statements, str, type, _i, _j, _k, _len, _len1, _len2, _ref4, _ref5;
      if (!isArray(nodes)) {
        return "";
      }
      type = nodes[0];
      ...
      switch (type) {
        ...
        case 'return':
          debug("RETURN");
          if (first[0] === 'call' && (_ref5 = first[1][1], __indexOf.call(TYPES, _ref5) >= 0)) {
            return parse(first);
          } else {
